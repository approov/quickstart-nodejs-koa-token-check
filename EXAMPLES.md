...
[Approov](https://approov.io) is an API security solution used to verify that requests received by your backend services originate from trusted versions of your mobile apps, and here you can find the Hello servers examples that are the base for the Approov [quickstarts](/docs) for NodeJS Koa framework.
...
If you are looking for the Approov quickstarts to integrate Approov in your NodeJS Koa API server then you can find them [here](/docs).
...
Now, you are ready to start using the Docker stack for NodeJS Koa.
